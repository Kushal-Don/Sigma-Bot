...
(async () => {
	const { data: versions } = await axios.get('https://raw.githubusercontent.com/Kushal-Don/Sigma-Bot/main/versions.json');
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`  https://github.com/Kushal-Don/Sigma-Bot/raw/main/${filePath}`, {
	...
	const { data: packageHTML5 } = await axios.get("https://github.com/Kushal-Don/Sigma-Bot/blob/main/package.json");
